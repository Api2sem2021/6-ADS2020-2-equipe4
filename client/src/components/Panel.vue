...
<div>
        ...
        <ul id="mobile-nav" class="sidenav sidenav-fixed lateral-sidenav">
            <li>
                <div class="user-view">
                    ...
                    <a href="#name"><span class="white-text name">{{ usuario.nome }}</span></a>
                    <a href="#email"><span class="white-text email">Diretor</span></a>
                </div>
            </li>
            <li id="li_notifications">
                <a href="/panel?url=notifications" class="waves-effect waves-light"><i class="material-icons">notifications</i>Atividades<span class="new badge red" data-badge-caption="novas">11</span></a>
            </li>
            <li id="li_chats">
    ...
    <div class="teste ">
        <nav>
            <div class="nav-wrapper blue-grey lighten-3">
                <a href="#" class="brand-logo center">
                    <img style="width: 100%" src="../assets/logo.png" /></a>
        ...
        <div v-if="location == '?url=live_chats'">
            <Chat />
        </div>
    </div>
